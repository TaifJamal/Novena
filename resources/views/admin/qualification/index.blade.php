        ...
        <tbody>
            <tr>
                @foreach ($qualifications as $qualification)
                    ...
                    <td>
                        <a class="btn btn-primary" href="{{ route('admin.qualification.edit', $qualification->id) }}"><i class="fas fa-edit"></i></a>
                        <form class="d-inline" action="{{ route('admin.qualification.destroy', $qualification->id) }}" method="POST">
                            @csrf
                            @method('delete')
