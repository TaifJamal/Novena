        ...
        <tbody>
            <tr>
                ...
                <td><img width="80" src="{{ asset('image/qualifications/'.$qualification->image) }}" alt=""></td>
                    <td>
                        <a class="btn btn-sm btn-primary" href="{{ route('admin.qualification.restore', $qualification->id) }}"><i class="fas fa-undo"></i></a>
                        <form class="d-inline" action="{{ route('admin.qualification.forcedelete', $qualification->id) }}" method="POST">
                            @csrf
                            @method('delete')
