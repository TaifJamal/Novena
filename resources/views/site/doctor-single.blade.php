@extends('site.master')
@section('titel','Doctor Detail | '.env('APP_NAME'))
@section('content')

@include('site.part.page',['name'=>'Doctor Details','content'=> $doctor->name ])
			...
			<div class="col-lg-4">
				<div class="skill-list">
					...
					<ul class="list-unstyled department-service">
                        ...
                        <li><i class="icofont-check mr-2"></i>{{ $expertise->content }}</li>
                        @endforeach
