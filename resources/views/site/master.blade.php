		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarmain">
				<ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item {{ request()->routeIs('site.department') ? 'active':'' }} " ><a class="nav-link" href="{{ route('site.department') }}">Departments</a></li>
                    <li class="nav-item {{ request()->routeIs('site.doctor') ? 'active':'' }} " ><a class="nav-link" href="{{ route('site.doctor') }}">Doctors</a></li>
				...
				<div class="widget mb-5 mb-lg-0">
					...
					<ul class="list-unstyled footer-menu lh-35">
                        @foreach ($app_departments as $department)
                         <li><a href="{{ route('site.department',$department->id) }}">{{$department->name}} </a></li>
                        @endforeach
					</ul>
				</div>
			</div>
